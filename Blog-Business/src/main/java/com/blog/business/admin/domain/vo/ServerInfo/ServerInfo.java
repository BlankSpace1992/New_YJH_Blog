...
import com.blog.utils.ArithUtils;
...
public class ServerInfo {
    ...
    private void setMemInfo(GlobalMemory memory) {
        mem.setTotal(ArithUtils.div(memory.getTotal(), (1024 * 1024 * 1024), 2));
        mem.setUsed(ArithUtils.div(memory.getTotal() - memory.getAvailable(), (1024 * 1024 * 1024), 2));
        mem.setFree(ArithUtils.div(memory.getAvailable(), (1024 * 1024 * 1024), 2));
        mem.setUsage(ArithUtils.mul(ArithUtils.div(memory.getTotal() - memory.getAvailable(), memory.getTotal(), 4), 100));
    }
    ...
    private void setJvmInfo() throws UnknownHostException {
        ...
        jvm.setUsed(ArithUtils.div(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory(), (1024 * 1024), 2));
        jvm.setUsage(ArithUtils.mul(ArithUtils.div(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory(), Runtime.getRuntime().totalMemory(), 4), 100));
