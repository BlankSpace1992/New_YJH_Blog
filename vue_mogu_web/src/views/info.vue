      ...
      <div class="newsview">
        ...
        <div class="bloginfo" v-if="blogData.blogSort.uid">
          <ul>
            ...
            <li class="createTime">
              <span class="iconfont">&#xe606;</span>
              {{dateFormat('YYYY-mm-dd HH:MM:SS',blogData.createTime)}}
            </li>
            <li class="view">
              <span class="iconfont">&#xe8c7;</span>
              {{blogData.clickCount}}
      ...
      <div class="news_pl" :style="opemCommentCss">
        ...
        <ul v-if="openComment == '1'">
          ...
          <div class="message_infos">
            ...
            <div class="noComment" v-if="comments===undefined||comments.length ==0">还没有评论，快来抢沙发吧！</div>
          </div>
        </ul>
      </div>
    </div>
    ...
    mounted() {
      ...
      $(window).scroll(function () {
        ...
        if (docHeight == winHeight + winScrollHeight) {
          if (that.comments === undefined || that.comments.length >= that.total) {
            console.log('已经到底了')
            return;
          }
          let params = {};
